            ...
            case MotionEvent.ACTION_MOVE:
                if (isTouchView(x,y)) {
                    ...
                    if (isLongPressed(pointDownX,pointDownY,x,y,pointDownTime,lastDownTime)) {
                        ...
                        if (rotateView.getScrollX() >= 0) {
                            if (dx > 0)
                                dx = 0;
                            //Log.w("haha", "111");
                        } else if (rotateView.getRight() * scale - rotateView.getScrollX() >= root.getRight()) {
                            if (dx < 0)
                                dx = 0;
                            //Log.w("haha", "222");
                        }

                        if (rotateView.getScrollY() >= 0) {
                            if (dy > 0)
                                dy = 0;
                            //Log.w("haha", "333");
                        } else if (rotateView.getBottom() * scale - rotateView.getScrollY() >= App.sScreenHeight) {
                            //Log.w("haha", "444");
